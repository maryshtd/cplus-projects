========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Дружественная перегрузка операторов
========================================================================

Это приложение Дружественная перегрузка операторов создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения Дружественная перегрузка операторов.


Дружественная перегрузка операторов.vcxproj
...
Дружественная перегрузка операторов.vcxproj.filters
...
Дружественная перегрузка операторов.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем Дружественная перегрузка операторов.pch и файла предкомпилированных типов с именем StdAfx.obj.
